...
architecture bhv of mips_rom is
  ...
  begin
      ...
      -- [20] add $t0, $t1, $t2       # $t0 = 3+8 = 11  (bonus: add com sinal)
      tmp(20) := "000000" & "01001" & "01010" & "01000" & "00000" & "100000";

      -- [21] sub $t0, $t2, $t1       # $t0 = 8-3 = 5   (bonus: sub com sinal)
      tmp(21) := "000000" & "01010" & "01001" & "01000" & "00000" & "100010";

      -- [22] addi $t0, $0, 7         # $t0 = 7          (bonus: addi com sinal)
      tmp(22) := "001000" & "00000" & "01000" & x"0007";

      -- [23] slt $t0, $t1, $t2       # $t0 = (3<8)=1    (bonus: slt com sinal)
      tmp(23) := "000000" & "01001" & "01010" & "01000" & "00000" & "101010";

      -- [24] j 0                     # loop volta ao inicio
      tmp(24) := "000010" & "00000000000000000000000000";
